        ...
        <table>
            ...
            while($re = mysqli_fetch_row($result)){?>
                <tr>
                    ...
                    <td><?php echo $re[3]?></td>
                    <td><?php echo $re[4]?></td>
                    <td><?php echo $re[5]?></td><td>
                <form method="post" action="modify!.php?id=<?php echo $re[0]?>">
                 <input type="submit" class="btn" value="Modify" name="mod">
                 </form></td><td>
                <form method="post" action="delete.php?id=<?php echo $re[0]?>">
                 <input type="submit" onclick="return confirm('정말로 삭제하시겠습니까?')" class="btn" value="Delete" name="del">
                 </form></td></tr>      
            <?php
            }
            ?>
