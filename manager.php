...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- 버튼 세개 -->
  <div class="w3-container w3-center" style="margin-top:12%;">
    <h4>MANAGER PAGE</h4> 
    <div class="w3-row">
        <div class="w3-col w3-container" style="width:33%; margin-top:8%;"> 
            <button class="w3-button w3-light-grey" onclick="location.href='addcloth.php'" style="margin-right:1%; width: 120px;height:45px; font-size:9pt;">상품 등록</button>
        </div>
      <div class="w3-col w3-container" style="width:33%; margin-top:8%;"> 
        <button class="w3-button w3-light-grey" onclick="location.href='clothlist.php'" style="margin-right:1%; width: 120px;height:45px; font-size:9pt;">상품 조회</button>
      </div>
      <div class="w3-col w3-container" style="width:33%; margin-top:8%;"> 
        <button class="w3-button w3-light-grey" onclick="location.href='memberlist.php'" style="margin-right:1%; width: 120px;height:45px; font-size:9pt;">회원리스트</button>
      </div>
    </div>
  </div>
<!-- 메인 화면 끝 -->
