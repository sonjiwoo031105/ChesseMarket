...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  <div class="w3-container w3-display-container w3-padding-16">
    ...
    <h3 class="w3-wide"><b><a href="main.php" class="w3-bar-item" style="text-decoration: none;">Cheese Market</a></b></h3>
  </div>
  <!-- 왼쪽 사이드바 메뉴-->
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-container">
    <h4 class="w3-center">Join</h4>
    <div class="w3-content w3-padding-16" style="max-width:510px">
        <form method="post" action="joinAction.php">
            <p><button type="submit" class="w3-button w3-black w3-padding-small" id="overbtn" name="idCheck" onclick="checkid();">중복확인</button></p>
            <p>아이디<input class="w3-input w3-border" type="text" placeholder="ID" name="userid" id="uid" required></p>
            ...
            <p>이름<input class="w3-input w3-border" type="text" placeholder="Name" name="name" id="input" required></p>
            <p>주소<input class="w3-input w3-border" type="text" placeholder="Address" name="address" id="input" required></p>
            <p>휴대전화<input class="w3-input w3-border" type="text" placeholder="PhoneNumber" name="tel" id="input" required></p>
            <p>SMS 수신여부<input class="w3-check" type="checkbox"><br>쇼핑몰에서 제공하는 유익한 이벤트 소식을 SMS로 받으실 수 있습니다.</p>
            <p>이메일<input class="w3-input w3-border" type="text" placeholder="Email" name="email" id="input" required></p>
            <p>이메일 수신여부<input class="w3-check" type="checkbox"><br>쇼핑몰에서 제공하는 유익한 이벤트 소식을 이메일로 받으실 수 있습니다.</p>
            <p>환불 계좌/은행<input class="w3-input w3-border" type="text" placeholder="Account" name="account" id="input" required></p>
