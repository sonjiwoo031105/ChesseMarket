...
#uid {float:right; width:194px; height:30px;}
#overbtn {float:right;}
</style>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-container">
    <h4 class="w3-center">상품 수정</h4>
    <div class="w3-content w3-padding-16" style="max-width:510px">
        <form method="post" action="modify!Action.php?id=<?php echo $id ?>">
            <p>이름<input class="w3-input w3-border" type="text" placeholder="Name" name="name" id="input" value="<?php echo $re[1]?>" required></p>
            <p>가격<input class="w3-input w3-border" type="text" placeholder="Price" name="price" id="input" value="<?php echo $re[2]?>" required></p>
            <p>수량<input class="w3-input w3-border" type="text" placeholder="Count" name="count" id="input" value="<?php echo $re[3]?>" required></p>
            <p>포인트(무통장)<input class="w3-input w3-border" type="text" placeholder="Point1" name="point1" id="input" value="<?php echo $re[4]?>" required></p>
            <p>포인트(카드)<input class="w3-input w3-border" type="text" placeholder="Point2" name="point2" id="input" value="<?php echo $re[5]?>" required></p>
            <p>이미지 URL<input class="w3-input w3-border" type="text" placeholder="Img_url" name="imgurl" id="input" value="<?php echo $re[6]?>" required></p>
            <button type="submit" class="w3-button w3-block w3-black">Modify</button>
        </form>   
    </div>
  </div>
<!-- 메인 화면 끝 -->
