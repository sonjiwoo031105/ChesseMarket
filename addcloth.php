...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <a href="new.php" class="w3-bar-item w3-button" id="new">NEW</a>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-container">
    <h4 class="w3-center">상품 등록</h4>
    <div class="w3-content w3-padding-16" style="max-width:510px">
        <form method="post" action="addclothAction.php">
            <p>이름<input class="w3-input w3-border" type="text" placeholder="Name" name="name" id="input" required></p>
            <p>가격<input class="w3-input w3-border" type="text" placeholder="Price" name="price" id="input" required></p>
            <p>수량<input class="w3-input w3-border" type="text" placeholder="Count" name="count" id="input" required></p>
            <p>포인트(무통장)<input class="w3-input w3-border" type="text" placeholder="Point1" name="point1" id="input" required></p>
            <p>포인트(카드)<input class="w3-input w3-border" type="text" placeholder="Point2" name="point2" id="input" required></p>
            <p>이미지 URL<input class="w3-input w3-border" type="text" placeholder="Img_url" name="imgurl" id="input" required></p>
